        ...
        <div class="r-container">
            <div class="d-flex flex-column text-center gap-3">
                ...
                <div class="row row-cols-1 row-cols-lg-3 text-start">
                    ...
                    <div class="col mb-3">
                        <div class="card border-0 bg-secondary-color p-3 shadow">
                            <img src="image/image-600x500-8.jpg" class="img-fluid" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card border-0 bg-secondary-color p-3 shadow">
                            <img src="image/image-600x500-2.jpg" class="img-fluid" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card border-0 bg-secondary-color p-3 shadow">
                            <img src="image/image-600x500-1.jpg" class="img-fluid" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card border-0 bg-secondary-color p-3 shadow">
                            <img src="image/image-600x500-11.jpg" class="img-fluid" alt="image">
                            <div class="card-body">
                    ...
                    <div class="col mb-3">
                        <div class="card border-0 bg-secondary-color p-3 shadow">
                            <img src="image/image-600x500-9.jpg" class="img-fluid" alt="image">
                            <div class="card-body">
                            ...
                            <div class="position-relative h-100">
                                ...
                                <div class="position-absolute start-0 top-0 w-100 h-100" style="z-index: 2;">
                                    <div class="d-flex justify-content-center align-items-center h-100">
                                        <button type="button" class="btn request-loader" data-bs-toggle="modal" data-bs-target="#modal-1" fdprocessedid="rdolvd">
                    ...
                    <div class="col  mb-3">
                        <div class="d-flex flex-column gap-3 h-100">
                            <div class="position-relative h-100">
                                ...
                                <div class="position-absolute start-0 top-0 w-100 h-100" style="z-index: 2;">
                                    <div class="d-flex justify-content-center align-items-center h-100">
                                        <button type="button" class="btn request-loader" data-bs-toggle="modal" data-bs-target="#modal-2" fdprocessedid="ajf894">
                                            <i class="fa-solid fa-play ms-1"></i>
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="col  mb-3">
                        <div class="d-flex flex-column gap-3 h-100">
                            <div class="position-relative h-100">
                                ...
                                <div class="position-absolute start-0 top-0 w-100 h-100" style="z-index: 2;">
                                    <div class="d-flex justify-content-center align-items-center h-100">
                                        <button type="button" class="btn request-loader" data-bs-toggle="modal" data-bs-target="#modal-3" fdprocessedid="kxl5hj">
                                            <i class="fa-solid fa-play ms-1"></i>
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex h-100 flex-column justify-content-center">
                            ...
                            <form class="w-100 form needs-validation">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" name="email" class="form-control py-3 px-4 form-white" placeholder="Your Email" aria-label="Recipient's username" aria-describedby="button-addon2" required="" fdprocessedid="veepzy">
                                    <button class="btn button btn_submit-subscribe font-1  fw-bold px-5" type="submit" id="button-addon2" fdprocessedid="nitev">Subscribe</button>
                                </div>
                            </form>
                        </div>
