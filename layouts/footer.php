                ...
                <div class="row row-cols-1 row-cols-lg-2 w-100">
                    <div class="col col-lg-4 mb-3">
                        <div class="d-flex flex-column gap-3">
                            ...
                            <p>
                                The NashCast is a YouTube podcast hosted by Adeel Shaikh & Nabeel Shaikh, and dedicated to powerful conversations that shape how people think, lead, and succeed.
                            ...
                            <div class="social-container mb-lg-0 mb-3">
                                ...
                                <a href="https://www.instagram.com/the.nash.cast/" class="social-item insta">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-instagram-icon lucide-instagram">
