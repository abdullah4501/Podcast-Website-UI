    ...
    <section class="section">
        <div class="r-container">
            <div class="row row-cols-1 row-cols-lg-2 mb-5">
                <div class="col mb-3">
                    <img src="image/host2.jpeg" alt="image" class="img-fluid rounded-3">
                </div>
                <div class="col mb-3">
                    <div class="d-flex flex-column h-100 justify-content-center gap-3">
                        ...
                        <p class="text-gray">
                            Specializing in finance, technology, and startup ecosystems, Nabeel brings a strategic lens to every conversation, helping listeners understand the frameworks behind successful businesses and the mindset shifts needed to scale impact.
                        </p>
                        <div>
                            <h5 class="font-1 fw-bold m-0">Nabeel Shaikh</h5>
                            <span class="logo-blue fw-medium">Founder &amp; Host of The NashCast</span>
                        </div>
            ...
            <div class="row row-cols-1 row-cols-lg-2">
                <div class="col mb-3">
                    <div class="d-flex flex-column h-100 justify-content-center gap-3">
                        ...
                        <p class="text-gray">
                            With expertise in leadership development and organizational psychology, Adeel explores the personal journeys behind professional success, helping listeners develop the mindset and resilience needed to lead effectively in complex environments.
                        </p>
                        <div>
                            <h5 class="font-1 fw-bold m-0">Adeel Shaikh</h5>
                            <span class="accent-color">Founder &amp; Host of The NashCast</span>
                        </div>
                        <div class="social-container gap-4">
                ...
                <div class="col mb-3">
                    <img src="image/host1.jpg" alt="image" class="img-fluid rounded-3">
                </div>
            </div>
        </div>
    </section>
